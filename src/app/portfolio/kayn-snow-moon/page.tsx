  ...
  return (
    ...
    >
      <span className="block">
        <span className="text-[#7dd3fc]">Kayn</span>{" "}
        <span className="text-white">Snow Moon</span>
      </span>
  ...
  return (
    <>
      ...
      <main className="bg-[#080808] text-white">
        <section className="relative overflow-hidden border-b border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(125,211,252,0.14),transparent_36%),radial-gradient(circle_at_top_right,rgba(255,140,58,0.14),transparent_38%),linear-gradient(180deg,#141414_0%,#0a0a0a_75%)] pt-20 md:pt-24">
          <div
              ...
              {showcaseModules.map((module) => {
                if (module.variant === "vimeo") {
                  return (
                    <div key={module.id} className="bg-black">
                      <div className="relative mx-auto aspect-video w-full max-w-[1600px]">
                        <iframe
                          src={module.embedSrc}
                          title={`${projectMeta.title} — video`}
                ...
                if (module.variant === "trio") {
                  return (
                    <div
                      key={module.id}
                      className="grid grid-cols-1 bg-[#222221] px-3 py-6 sm:grid-cols-3 sm:px-4 md:py-10"
                    >
                ...
                if (module.variant === "duo") {
                  return (
                    <div
                      key={module.id}
                      className="grid grid-cols-1 bg-[#222221] px-3 py-6 md:grid-cols-2 md:px-4 md:py-10"
                    >
                      {module.srcs.map((src, i) => (
                        <div
                          key={`${module.id}-${i}`}
                        ...
                        >
                          ...
                          <img
                            src={src}
                            alt={`${projectMeta.title} module ${module.id} ${i + 1}`}
                            className="block h-auto w-full max-w-[720px] object-contain"
                            loading="lazy"
                          />
                        </div>
                      ))}
