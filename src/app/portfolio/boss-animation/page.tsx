  ...
  return (
    ...
    >
      <span className="block">
        <span className="text-[#ffb000]">Boss</span>{" "}
        <span className="text-white">Animation</span>
      </span>
      <span className="mt-1 block text-[0.62em] font-black tracking-[0.06em] text-white/75 md:text-[0.58em]">
        The Twins · Spine 2D Reels
      </span>
    </h1>
  );
}
  ...
  return (
    <>
      ...
      <main className="bg-[#080808] text-white">
        <section className="relative overflow-hidden border-b border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(255,176,0,0.16),transparent_36%),radial-gradient(circle_at_top_right,rgba(255,140,58,0.16),transparent_38%),linear-gradient(180deg,#141414_0%,#0a0a0a_75%)] pt-20 md:pt-24">
          <div
          ...
          >
            ...
            <div className="flex h-full flex-col">
              <HeroCover
                poster={projectMeta.coverImage}
                videoEmbed={projectMeta.coverVideoEmbed}
              ...
              {showcaseModules.map((module) => {
                if (module.variant === "closing") {
                  return (
                    <div
                      key={module.id}
                      className="flex items-center justify-center bg-black px-6 py-14 md:py-20"
                    >
                      <p className="text-center text-[22px] font-bold text-[#8c8c8c] md:text-[25px]">
                        {module.text}
                      </p>
                    </div>
                  );
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <Image
                          src={module.src}
                          alt={`${projectMeta.title} — ${module.id}`}
                          fill
                    ...
                    >
                      <div className="text-center">
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-[0.18em] text-[#00bfff] underline underline-offset-4 transition-opacity hover:opacity-80 md:text-base"
                        >
                          <svg
                            viewBox="0 0 24 24"
                            fill="currentColor"
