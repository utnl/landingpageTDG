...
export default function HeroCover({ poster, videoEmbed, title }: Props) {
  ...
  return (
    <div className="relative aspect-video w-full overflow-hidden rounded-[26px] border border-white/10 bg-black shadow-[0_30px_80px_-30px_rgba(255,140,58,0.35)]">
      {playing ? (
        <iframe
          src={videoEmbed}
          title={`${title} — splash art animation`}
