  ...
  return (
    ...
    >
      <span className="block">
        <span className="text-[#ffb000]">Horse</span>{" "}
      ...
      <main className="bg-[#080808] text-white">
        ...
        <section className="border-b border-white/8 bg-[#191919] py-14 md:py-18">
          ...
          >
            ...
            <div className="space-y-6 overflow-hidden rounded-[28px]">
              {showcaseModules.map((module) => {
                if (module.variant === "closing") {
                  return (
                    <div
                      key={module.id}
                      className="flex items-center justify-center bg-black px-6 py-16 md:py-24"
                    >
                      <h3
                        className="text-center text-3xl font-black uppercase tracking-[0.08em] text-[#ff7700] md:text-5xl"
                        style={{ fontFamily: "var(--font-rajdhani)" }}
                      >
                        {module.text}
                      </h3>
