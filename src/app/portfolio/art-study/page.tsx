                  ...
                  <div className="mt-3 flex flex-1 flex-wrap content-start gap-2">
                    {projectMeta.fields.map((field) => (
                      <span
                        ...
                        style={{
                          background: `linear-gradient(135deg, ${projectMeta.theme?.accent || "#ff8c3a"}20 0%, ${projectMeta.theme?.accent || "#ff8c3a"}10 100%)`,
                          border: `1px solid ${projectMeta.theme?.accent || "#ff8c3a"}50`,
                          color: `${projectMeta.theme?.accentSoft || "#3b82f6"}ff`,
                          boxShadow: `0 2px 8px ${projectMeta.theme?.accent || "#ff8c3a"}15`,
                        }}
                      >
                        {field}
                      </span>
                ...
                <div className="md:col-span-3 rounded-[20px] border border-white/10 bg-black/20 p-4">
                  <div className="flex items-center gap-3">
                    <span
                      ...
                      style={{ backgroundColor: projectMeta.theme?.accent || "#ff8c3a" }}
                    />
